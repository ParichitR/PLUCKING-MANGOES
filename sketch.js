...
function setup() {
	...
	mango2=new Mango(650,200,40)
	mango3=new Mango(700,150,40)
	mango4=new Mango(750,100,40)
	mango5=new Mango(800,300,40)
	mango6=new Mango(780,200,40)
	mango7=new Mango(670,150,40)
	mango8=new Mango(710,250,40)
